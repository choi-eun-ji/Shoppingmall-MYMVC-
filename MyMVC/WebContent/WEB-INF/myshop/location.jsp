...
<style>
 ...
 --%> 
 <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=0270d5c0fb11584f5f42d7a6d526fe15"></script> 
       ...
       kakao.maps.event.addListener(mapobj, 'click', function(mouseEvent) {
        ...
        $.ajax({
           ...
           async:false, // !!!! 지도는 비동기 통신이 아닌 동기 통신으로 해야 한다 !!!!
                        // async:true  ==> 비동기 통신이다. 생략하더라도 기본값이  true 로 되어진다.
                        // async:false ==> 동기 통신이다.
           dataType:"JSON",
